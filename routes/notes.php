...
Route::group([
    ...
    Route::post('/index', [
        'as' => 'playground.matrix.api.notes.index',
        'uses' => 'NoteController@index',
    ])->can('index', Note::class);
