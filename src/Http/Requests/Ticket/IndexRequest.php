...
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationColumns = [
        ...
        'handler' => ['column' => 'handler', 'label' => 'Handler', 'type' => 'string', 'nullable' => true],
        'key' => ['column' => 'key', 'label' => 'Key', 'type' => 'string', 'nullable' => true],
        'code' => ['column' => 'code', 'label' => 'Code', 'type' => 'bigInteger', 'nullable' => true],
        'key_code_hash' => ['column' => 'key_code_hash', 'label' => 'Key code hash', 'type' => 'string', 'nullable' => true],
        'priority' => ['column' => 'priority', 'label' => 'Priority', 'type' => 'string', 'nullable' => true],
        'severity' => ['column' => 'severity', 'label' => 'Severity', 'type' => 'string', 'nullable' => true],
        'resolution' => ['column' => 'resolution', 'label' => 'Resolution', 'type' => 'string', 'nullable' => true],
        'step' => ['column' => 'step', 'label' => 'Step', 'type' => 'string', 'nullable' => true],
        'state' => ['column' => 'state', 'label' => 'State', 'type' => 'string', 'nullable' => true],
        'workflow_type' => ['column' => 'workflow_type', 'label' => 'Workflow type', 'type' => 'string', 'nullable' => true],
        'points' => ['column' => 'points', 'label' => 'Points', 'type' => 'bigInteger', 'nullable' => true],
